...
var AdvertisementFormComponent = (function () {
    function AdvertisementFormComponent() {
        //arrName =new Array();
        //arrCat =new Array();
        //arrDesc =new Array();
    ...
    AdvertisementFormComponent.prototype.AdDetails_All = function (name, cat, desc) {
    ...
    AdvertisementFormComponent.prototype.onChange = function (name, cat, desc) {
        var newobj = {
            newName: name,
            newCat: cat,
            newDesc: desc
...
//# sourceMappingURL=AdevrtisementForm.js.map